...
{
    [Test]
    public void OneRowPyramidTest()
    {
        var oneRowPyramid = new[]
        {
            new[] {100}
        };

        Assert.AreEqual(100, PyramidSlideDown.LongestSlideDown(oneRowPyramid));
    }

    [Test]
    public void TwoRowsPyramidTest()
    {
        var twoRowsPyramid = new[]
        {
            new[] {100},
            new[] {50, 5}
        };

        Assert.AreEqual(150, PyramidSlideDown.LongestSlideDown(twoRowsPyramid));
    }

    [Test]
    public void ThreeRowsPyramidTest()
    {
        var threeRowsPyramid = new[]
        {
            new[] {100},
            new[] {50, 5},
            new[] {5, 150, 10}
        ...
        Assert.AreEqual(300, PyramidSlideDown.LongestSlideDown(threeRowsPyramid));
    }
