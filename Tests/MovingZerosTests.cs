...
public class MovingZerosTests
{
    ...
    {
        Assert.AreEqual(new int[] { 1, 2, 1, 1, 3, 1, 0, 0, 0, 0 },
            Kata.MoveZeroesLinqRemove(new int[] { 1, 2, 0, 1, 0, 1, 0, 3, 0, 1 }));
    }
    ...
    {
        Assert.AreEqual(new int[] { 5, 1, 2, 0, 0 },
            Kata.MoveZeroesLinqRemove(new int[] { 0, 5, 0, 1, 2 }));
    }
    ...
    {
        Assert.AreEqual(new int[] { 2, 5, 0 },
            Kata.MoveZeroesLinqRemove(new int[] { 0, 2, 5 }));
    }
    ...
    {
        Assert.AreEqual(new int[] { },
            Kata.MoveZeroesLinqRemove(new int[] { }));
    }
